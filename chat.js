...
function display_new_msg() {
  ...
  for (var i = 0; i < msgs.length; i++) {
    document.getElementById("msg_box").innerHTML =  "<div id='msg'><hr style='width: 40%; align: left;'><div id='msg_header'>" + msgs[i]["head"] + "</div><div id='msg_body'>" + msgs[i]["body"] + "</div></div>" + document.getElementById("msg_box").innerHTML;
  };
};
